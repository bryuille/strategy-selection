...
from eye_pre_flash.maze_strategy_pairs import cells as cellmod
...
def session_cells(X, mazes, y, *, min_trials=MIN_TRIALS, skip_cells=()):
    ...
    anchor-minority cells, 1S and 6H -- see `eye_pre_flash.label_sources`),
...
def label_similarity_matrix(
    ...
    *,
    ...
    `occ_bin`, `bigram`, already through a `eye_pre_flash.maze_strategy_pairs.variants`
...
def permutation_null(
    ...
    **kw,
    ...
    """
    from eye_pre_flash.maze_strategy_pairs.cells import within_maze_delta, within_maze_table
