...
Usage:
    uv run python -m eye_pre_flash.plotting.heatmap_label.sum_log_norm
    uv run python -m eye_pre_flash.plotting.heatmap_label.sum_log_norm --scope publication
    uv run python -m eye_pre_flash.plotting.heatmap_label.sum_log_norm --monkey Nielsen --bin-w 0.142857
"""
