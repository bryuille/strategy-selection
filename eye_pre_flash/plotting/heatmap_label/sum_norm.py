...
Usage:
    uv run python -m eye_pre_flash.plotting.heatmap_label.sum_norm
    uv run python -m eye_pre_flash.plotting.heatmap_label.sum_norm --scope allplus
    uv run python -m eye_pre_flash.plotting.heatmap_label.sum_norm --monkey Faure --bin-w 0.142857
"""
