...
Usage:
    uv run python -m eye_pre_flash.plotting.heatmap_label.sum_log_norm_diff
    uv run python -m eye_pre_flash.plotting.heatmap_label.sum_log_norm_diff --scope all
    uv run python -m eye_pre_flash.plotting.heatmap_label.sum_log_norm_diff --monkey Faure --bin-w 0.142857
"""
