...
Usage:
    uv run python -m eye_pre_flash.plotting.heatmap_label.sum_log
    uv run python -m eye_pre_flash.plotting.heatmap_label.sum_log --scope all
    uv run python -m eye_pre_flash.plotting.heatmap_label.sum_log --monkey Faure --bin-deg 1
"""
