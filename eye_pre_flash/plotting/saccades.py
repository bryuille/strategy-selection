...
Usage:
    ...
    uv run python -m eye_pre_flash.plotting.saccades --session june_24_g0 --maze 1 --view trial --trial-id 141
    uv run python -m eye_pre_flash.plotting.saccades --session june_24_g0 --maze 1 --mode 3d --save
"""
