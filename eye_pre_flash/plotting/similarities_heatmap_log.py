...
Usage:
    uv run python -m eye_pre_flash.plotting.similarities_heatmap_log --monkey Faure
    uv run python -m eye_pre_flash.plotting.similarities_heatmap_log --monkey Nielsen
    uv run python -m eye_pre_flash.plotting.similarities_heatmap_log --monkey Faure --bin-w 0.142857
"""
...
from eye_pre_flash.plotting import heatmaps as _heatmaps
from eye_pre_flash.plotting.labeled_saccades import _event_lookup
from eye_pre_flash.plotting.plot_io import save_figure
from eye_pre_flash.plotting.similarities_common import BLUE_YELLOW

VISUALIZER = "similarities_heatmap_log"
...
def _collect_trials(eye, behavioral, *, event_lookup=None, event_kind=None):
