...
Usage:
    uv run python -m eye_pre_flash.plotting.similarities_heatmap_saccades --monkey Faure
    uv run python -m eye_pre_flash.plotting.similarities_heatmap_saccades --monkey Nielsen
    uv run python -m eye_pre_flash.plotting.similarities_heatmap_saccades --monkey Faure --bin-w 0.142857
"""
...
from eye_pre_flash.plotting.similarities_heatmap_log import (
    COARSE_BIN,
    DEFAULT_BIN,
    MIN_TRIALS,
    N_SPLITS,
...
VISUALIZER = "similarities_heatmap_saccades"
