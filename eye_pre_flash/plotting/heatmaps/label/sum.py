...
Usage:
    ...
    uv run python -m eye_pre_flash.plotting.heatmaps.label.sum --scope publication
    uv run python -m eye_pre_flash.plotting.heatmaps.label.sum --monkey Faure --bin-deg 1
"""
