...
Usage:
    uv run python -m eye_pre_flash.plotting.heatmaps.maze.sum_norm_diff --monkey Faure
    uv run python -m eye_pre_flash.plotting.heatmaps.maze.sum_norm_diff --monkey Nielsen
    uv run python -m eye_pre_flash.plotting.heatmaps.maze.sum_norm_diff --monkey Faure --bin-w 0.142857
"""
