...
Usage:
    uv run python -m eye_pre_flash.plotting.heatmaps.maze.core --monkey Faure
    uv run python -m eye_pre_flash.plotting.heatmaps.maze.core --monkey Faure --maze 1
    uv run python -m eye_pre_flash.plotting.heatmaps.maze.core --monkey Nielsen --bin-deg 1
"""
