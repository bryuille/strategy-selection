...
Usage:
    uv run python -m eye_pre_flash.plotting.heatmaps.maze.sum --monkey Faure
    uv run python -m eye_pre_flash.plotting.heatmaps.maze.sum --monkey Nielsen
    uv run python -m eye_pre_flash.plotting.heatmaps.maze.sum --monkey Faure --bin-deg 1
"""
