...
Usage:
    uv run python -m eye_pre_flash.plotting.heatmaps_sum_norm --monkey Faure
    uv run python -m eye_pre_flash.plotting.heatmaps_sum_norm --monkey Nielsen
    uv run python -m eye_pre_flash.plotting.heatmaps_sum_norm --monkey Faure --bin-w 0.142857
"""
...
from eye_pre_flash.plotting.heatmaps import (
    DEFAULT_BIN_DEG,
    FIXATION_STEM_DEG,
    HALF_DEG,
    PRE_FIX_END_MS,
...
from eye_pre_flash.plotting.heatmaps_sum import COARSE_BIN_DEG, MAZE_GROUPS
from eye_pre_flash.plotting.plot_io import save_figure

VISUALIZER = "heatmaps_sum_norm"
