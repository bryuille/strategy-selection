...
Usage:
    uv run python -m eye_pre_flash.plotting.similarities.occupancy --monkey Faure
    uv run python -m eye_pre_flash.plotting.similarities.occupancy --monkey Nielsen
