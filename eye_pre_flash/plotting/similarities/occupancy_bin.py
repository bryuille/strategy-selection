...
Usage:
    ...
    uv run python -m eye_pre_flash.plotting.similarities.occupancy_bin --monkey Nielsen
    uv run python -m eye_pre_flash.plotting.similarities.occupancy_bin --monkey Faure --k 12
"""
