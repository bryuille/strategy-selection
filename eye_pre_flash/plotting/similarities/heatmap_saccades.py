...
Usage:
    uv run python -m eye_pre_flash.plotting.similarities.heatmap_saccades --monkey Faure
    uv run python -m eye_pre_flash.plotting.similarities.heatmap_saccades --monkey Nielsen
    uv run python -m eye_pre_flash.plotting.similarities.heatmap_saccades --monkey Faure --bin-w 0.142857
"""
...
VISUALIZER = "similarities/heatmap_saccades"
