...
Usage:
    ...
    uv run python -m eye_pre_flash.plotting.similarities.heatmap --monkey Nielsen
    uv run python -m eye_pre_flash.plotting.similarities.heatmap --monkey Faure --bin-w 0.142857
"""
