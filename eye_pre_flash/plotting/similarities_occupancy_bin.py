...
Usage:
    ...
    uv run python -m eye_pre_flash.plotting.similarities_occupancy_bin --monkey Nielsen
    uv run python -m eye_pre_flash.plotting.similarities_occupancy_bin --monkey Faure --k 12
"""
...
from eye_pre_flash.plotting.similarities_common import (
    N_SPLITS,
    plot_cv_grid,
    session_averaged_cv,
)

VISUALIZER = "similarities_occupancy_bin"
PRE_FIX_END_MS = 0
