...
Same raw summed counts as ``heatmaps_sum_norm``. Hierarchical
...
Usage:
    uv run python -m eye_pre_flash.plotting.heatmaps_sum_norm_diff --monkey Faure
    uv run python -m eye_pre_flash.plotting.heatmaps_sum_norm_diff --monkey Nielsen
    uv run python -m eye_pre_flash.plotting.heatmaps_sum_norm_diff --monkey Faure --bin-w 0.142857
"""
...
VISUALIZER = "heatmaps_sum_norm_diff"
