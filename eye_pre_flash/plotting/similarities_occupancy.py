...
Usage:
    uv run python -m eye_pre_flash.plotting.similarities_occupancy --monkey Faure
    uv run python -m eye_pre_flash.plotting.similarities_occupancy --monkey Nielsen
...
from eye_pre_flash.plotting.plot_io import PRE_FIX_START_MS, save_figure
from eye_pre_flash.plotting.similarities_common import BLUE_YELLOW

VISUALIZER = "similarities_occupancy"
PRE_FIX_END_MS = 0
MAZES = range(1, 7)
N_SPLITS = 20
