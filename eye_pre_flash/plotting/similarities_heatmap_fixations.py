...
Usage:
    uv run python -m eye_pre_flash.plotting.similarities_heatmap_fixations --monkey Faure
    uv run python -m eye_pre_flash.plotting.similarities_heatmap_fixations --monkey Nielsen
    uv run python -m eye_pre_flash.plotting.similarities_heatmap_fixations --monkey Faure --bin-w 0.142857
"""
...
VISUALIZER = "similarities_heatmap_fixations"
