...
Usage:
    uv run python -m eye_pre_flash.plotting.attractor_saccades --session june_24_g0 --maze 1
    uv run python -m eye_pre_flash.plotting.attractor_saccades --session june_24_g0 --maze 1 --view trials
    uv run python -m eye_pre_flash.plotting.attractor_saccades --session june_24_g0 --maze 1 --view trial --trial-id 141
"""
...
from data.loader import load_attractor_eye_data, load_eye_behavioral_data, load_eye_data
from eye_pre_flash.plotting.plot_io import PRE_FIX_WINDOW_MS, save_figure
from eye_pre_flash.plotting.saccades import (
    _behavioral_lookup,
    _fix_start_ms,
    _median_geometry,
    _time_window_label,
