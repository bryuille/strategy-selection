...
Usage:
    uv run python -m eye_pre_flash.plotting.heatmaps_sum_log_norm_diff --monkey Faure
    uv run python -m eye_pre_flash.plotting.heatmaps_sum_log_norm_diff --monkey Nielsen
    uv run python -m eye_pre_flash.plotting.heatmaps_sum_log_norm_diff --monkey Faure --bin-w 0.142857
"""
...
from eye_pre_flash.plotting.heatmaps_sum_norm import (
    COARSE_BIN,
    DEFAULT_BIN,
    DEG_TO_UNIT_H,
    FIXATION_STEM_DEG,
)
from eye_pre_flash.plotting.heatmaps_sum_norm_diff import plot_diff as _plot_diff

VISUALIZER = "heatmaps_sum_log_norm_diff"
