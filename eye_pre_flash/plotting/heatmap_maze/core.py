...
Usage:
    uv run python -m eye_pre_flash.plotting.heatmap_maze.core --monkey Faure
    uv run python -m eye_pre_flash.plotting.heatmap_maze.core --monkey Faure --maze 1
    uv run python -m eye_pre_flash.plotting.heatmap_maze.core --monkey Nielsen --bin-deg 1
"""
...
from eye_pre_flash.plotting.plot_io import PRE_FIX_END_MS, PRE_FIX_START_MS, save_figure, window_label

VISUALIZER = "heatmap_maze/per_maze"
HALF_DEG = 20.0
