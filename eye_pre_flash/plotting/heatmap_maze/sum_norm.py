...
Usage:
    uv run python -m eye_pre_flash.plotting.heatmap_maze.sum_norm --monkey Faure
    uv run python -m eye_pre_flash.plotting.heatmap_maze.sum_norm --monkey Nielsen
    uv run python -m eye_pre_flash.plotting.heatmap_maze.sum_norm --monkey Faure --bin-w 0.142857
"""
...
from eye_pre_flash.plotting.heatmap_maze.sum import COARSE_BIN_DEG, MAZE_GROUPS
from eye_pre_flash.plotting.plot_io import save_figure, window_label

VISUALIZER = "heatmap_maze/sum_norm"
