...
Usage:
    uv run python -m eye_pre_flash.plotting.heatmap_maze.sum_norm_diff --monkey Faure
    uv run python -m eye_pre_flash.plotting.heatmap_maze.sum_norm_diff --monkey Nielsen
    uv run python -m eye_pre_flash.plotting.heatmap_maze.sum_norm_diff --monkey Faure --bin-w 0.142857
"""
...
VISUALIZER = "heatmap_maze/sum_norm_diff"
