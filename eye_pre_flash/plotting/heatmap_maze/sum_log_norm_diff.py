...
Usage:
    uv run python -m eye_pre_flash.plotting.heatmap_maze.sum_log_norm_diff --monkey Faure
    uv run python -m eye_pre_flash.plotting.heatmap_maze.sum_log_norm_diff --monkey Nielsen
    uv run python -m eye_pre_flash.plotting.heatmap_maze.sum_log_norm_diff --monkey Faure --bin-w 0.142857
"""
...
from eye_pre_flash.plotting.heatmap_maze.sum_norm_diff import plot_diff as _plot_diff

VISUALIZER = "heatmap_maze/sum_log_norm_diff"
