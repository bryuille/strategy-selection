...
Usage:
    uv run python -m eye_pre_flash.plotting.heatmap_maze.sum_log --monkey Faure
    uv run python -m eye_pre_flash.plotting.heatmap_maze.sum_log --monkey Nielsen
    uv run python -m eye_pre_flash.plotting.heatmap_maze.sum_log --monkey Faure --bin-deg 1
"""
...
from eye_pre_flash.plotting.heatmap_maze.sum import (
    COARSE_BIN_DEG,
    MAZE_GROUPS,
    _sum_group,
)
...
VISUALIZER = "heatmap_maze/sum_log"
