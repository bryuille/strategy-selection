...
`eye_pre_flash.mazestratpair.run` renders one 1x3 figure (full / no_origin /
...
Usage:
    uv run python -m eye_pre_flash.pres.mazestratpair.build
    uv run python -m eye_pre_flash.pres.mazestratpair.build --maze 2 --n-perm 2000
...
from eye_pre_flash.corr.figures import FEATURE_LABEL, SOURCE_LABEL
from eye_pre_flash.corr.labels import WIDEST_SCOPE, source_lookup, source_scope_sessions
from eye_pre_flash.corr.run import FEATURES, SPACE
from eye_pre_flash.mazestratpair import pair
from eye_pre_flash.mazestratpair.run import pair_labels
