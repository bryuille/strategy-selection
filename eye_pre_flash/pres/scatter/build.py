...
Usage:
    uv run python -m eye_pre_flash.pres.scatter.build
    uv run python -m eye_pre_flash.pres.scatter.build --monkey Faure --source svm
    uv run python -m eye_pre_flash.pres.scatter.build --scope publication
