\begin{table}[t]
\centering
\caption{Faure -- across-maze decoding (unit-H features, scope: allplus). Balanced accuracy, chance = 0.500}
...
Gaze heatmap, 10x10 & 100 & 2448 & 0.629 & \textbf{0.589} & 0.933 & \textbf{0.590} \\
