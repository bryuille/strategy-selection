\begin{table}[t]
\centering
\caption{Nielsen -- across-maze decoding (unit-H features, scope: all). Balanced accuracy, chance = 0.500}
...
Codebook occupancy (binary), K=12 & 12 & 1746 & 0.634 & \textbf{0.627} & 0.670 & 0.599 \\
...
Gaze heatmap, 10x10 & 100 & 1746 & 0.665 & 0.623 & 0.903 & \textbf{0.636} \\
