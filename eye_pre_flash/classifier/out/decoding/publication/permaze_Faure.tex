\begin{table}[t]
\centering
\caption{Faure -- per-maze decoding (degrees features, scope: publication). Balanced accuracy, chance = 0.500}
...
\midrule
Codebook occupancy (ms), K=6 & 6 & 477 & 4 & 0.661 & \textbf{0.558} & 0.979 & 0.491 \\
Codebook occupancy (ms), K=12 & 12 & 477 & 4 & 0.720 & 0.515 & 0.985 & 0.488 \\
Codebook occupancy (binary), K=6 & 6 & 477 & 4 & 0.658 & 0.512 & 0.695 & \textbf{0.547} \\
