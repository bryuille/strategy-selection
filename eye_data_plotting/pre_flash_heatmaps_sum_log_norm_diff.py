...
Same raw summed counts as ``pre_flash_heatmaps_sum_log_norm``, displayed as
...
Usage:
    uv run python -m eye_data_plotting.pre_flash_heatmaps_sum_log_norm_diff --monkey Faure
    uv run python -m eye_data_plotting.pre_flash_heatmaps_sum_log_norm_diff --monkey Nielsen
    uv run python -m eye_data_plotting.pre_flash_heatmaps_sum_log_norm_diff --monkey Faure --bin-w 0.142857
"""
...
from eye_data_plotting.pre_flash_heatmaps_sum_norm_diff import plot_diff as _plot_diff

VISUALIZER = "pre_flash_heatmaps_sum_log_norm_diff"
