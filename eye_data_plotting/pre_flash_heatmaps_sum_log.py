...
Same raw summed counts as ``pre_flash_heatmaps_sum``, displayed as
...
Usage:
    ...
    uv run python -m eye_data_plotting.pre_flash_heatmaps_sum_log --monkey Faure --bin-deg 1
"""
...
from eye_data_plotting.pre_flash_heatmaps import (
    DEFAULT_BIN_DEG,
    HALF_DEG,
    PRE_FIX_END_MS,
    PRE_FIX_START_MS,
...
from eye_data_plotting.pre_flash_heatmaps_sum import (
    COARSE_BIN_DEG,
    MAZE_GROUPS,
    _sum_group,
)

VISUALIZER = "pre_flash_heatmaps_sum_log"
