...
Usage:
    ...
    uv run python -m eye_data_plotting.pre_flash_similarities_heatmap_log --monkey Faure --bin-w 0.142857
"""
...
from eye_data_plotting import pre_flash_heatmaps as _heatmaps
from eye_data_plotting.plot_io import save_figure
from eye_data_plotting.pre_flash_labeled_saccades import _event_lookup
from eye_data_plotting.similarities_common import BLUE_YELLOW

VISUALIZER = "pre_flash_similarities_heatmap_log"
...
def _collect_trials(eye, behavioral, *, event_lookup=None, event_kind=None):
    ...
    `pre_flash_labeled_saccades._event_lookup`).
    """
