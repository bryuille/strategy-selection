...
Usage:
    uv run python -m eye_data_plotting.pre_flash_movie
    uv run python -m eye_data_plotting.pre_flash_movie --start-trial 41 --n-trials 30
"""
