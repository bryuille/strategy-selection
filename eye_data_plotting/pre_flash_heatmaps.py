...
Usage:
    ...
    uv run python -m eye_data_plotting.pre_flash_heatmaps --monkey Nielsen --bin-deg 1
"""
...
from eye_data_plotting.plot_io import PRE_FIX_END_MS, PRE_FIX_START_MS, save_figure

VISUALIZER = "pre_flash_heatmaps"
HALF_DEG = 20.0
