...
Usage:
    ...
    uv run python -m eye_data_plotting.pre_flash_heatmaps_sum_norm --monkey Faure --bin-w 0.142857
"""
...
from eye_data_plotting.pre_flash_heatmaps_sum import COARSE_BIN_DEG, MAZE_GROUPS

VISUALIZER = "pre_flash_heatmaps_sum_norm"
