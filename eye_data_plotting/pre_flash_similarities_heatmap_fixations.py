...
Usage:
    uv run python -m eye_data_plotting.pre_flash_similarities_heatmap_fixations --monkey Faure
    uv run python -m eye_data_plotting.pre_flash_similarities_heatmap_fixations --monkey Nielsen
    uv run python -m eye_data_plotting.pre_flash_similarities_heatmap_fixations --monkey Faure --bin-w 0.142857
"""
...
VISUALIZER = "pre_flash_similarities_heatmap_fixations"
