...
Same 2D views as `eye_data_plotting.pre_flash_saccades`, with vertical borders at
each saccade/fixation onset and offset and a text label for the event type.

Usage:
    uv run python -m eye_data_plotting.pre_flash_labeled_saccades --session june_24_g0 --maze 1
    uv run python -m eye_data_plotting.pre_flash_labeled_saccades --session june_24_g0 --maze 1 --view trials
    uv run python -m eye_data_plotting.pre_flash_labeled_saccades --session june_24_g0 --maze 1 --view trial --trial-id 141
"""
...
VISUALIZER = "pre_flash_labeled_saccades"
EVENT_STYLE = {
