...
Same raw summed counts as ``pre_flash_heatmaps_sum_norm``, displayed as
...
Usage:
    ...
    uv run python -m eye_data_plotting.pre_flash_heatmaps_sum_log_norm --monkey Faure --bin-w 0.142857
"""
...
VISUALIZER = "pre_flash_heatmaps_sum_log_norm"
