...
Same split-half CV as ``pre_flash_similarities_heatmap_log``, but each
...
Usage:
    ...
    uv run python -m eye_data_plotting.pre_flash_similarities_heatmap --monkey Faure --bin-w 0.142857
"""
...
VISUALIZER = "pre_flash_similarities_heatmap"
