\begin{table}[t]
\centering
\caption{Nielsen -- per-maze decoding (degrees features, scope: publication). Balanced accuracy, chance = 0.500}
...
State bigrams, K=6 & 36 & 608 & 4 & 0.703 & 0.534 & 0.729 & \textbf{0.572} \\
State bigrams, K=12 & 144 & 608 & 4 & 0.846 & 0.540 & 0.790 & 0.566 \\
Gaze heatmap, 5x5 & 25 & 608 & 4 & 0.731 & \textbf{0.595} & 0.887 & 0.559 \\
