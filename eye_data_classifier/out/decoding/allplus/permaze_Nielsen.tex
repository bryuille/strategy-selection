\begin{table}[t]
\centering
\caption{Nielsen -- per-maze decoding (degrees features, scope: allplus). Balanced accuracy, chance = 0.500}
...
\midrule
Codebook occupancy (ms), K=6 & 6 & 2635 & 6 & 0.577 & \textbf{0.540} & 0.924 & 0.525 \\
...
Gaze heatmap, 10x10 & 100 & 2635 & 6 & 0.705 & 0.523 & 0.927 & \textbf{0.534} \\
\bottomrule
\end{tabular}
\par\smallskip
