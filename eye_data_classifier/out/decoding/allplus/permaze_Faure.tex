\begin{table}[t]
\centering
\caption{Faure -- per-maze decoding (degrees features, scope: allplus). Balanced accuracy, chance = 0.500}
...
Codebook occupancy (ms), K=12 & 12 & 2448 & 6 & 0.636 & \textbf{0.589} & 0.967 & 0.562 \\
Codebook occupancy (binary), K=6 & 6 & 2448 & 6 & 0.608 & 0.582 & 0.632 & \textbf{0.578} \\
